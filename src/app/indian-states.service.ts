...
export class IndianStatesService {
  ...
  dailyConfirmedCases = [
    ...
    2342, 2419, 2539, 2766, 2888, 3031, 3125, 3279, 3437, 3652, 3796, 4133, 4365, 4629, 4805, 4917, 5367, 6128, 6128], label: 'North Zone', fill: false },
    { data: [422, 493, 598, 799, 958, 1047, 1169, 1409, 1598, 1768, 1948, 2070, 2240, 2392, 2472, 2710, 2925, 3036,
    3195, 3348, 3503, 3624, 3791, 4042, 4230, 4390, 4562, 4774, 4914, 5085, 5243, 5461, 5577, 5867, 6155, 6550, 6550], label: 'South', fill: false, borderColor: 'red'  },
    { data: [35, 42, 55, 71, 86, 108, 134, 163, 167, 200, 215, 230, 267, 286, 304, 327, 374, 417,
    440, 478, 518, 545, 598, 679, 730, 790, 890, 1007, 1087, 1171, 1321, 1389, 1439, 1525, 1588, 1743, 1743], label: 'East', fill: false },
    { data: [256, 289, 381, 427, 508, 521, 602, 619, 899, 1040, 1190, 1321, 1612, 1889, 2200, 2531, 2961, 3389,
    3797, 4233, 4602, 5262, 6061, 6742, 7500, 8066, 9061, 9639, 10706, 11376, 12145, 13069, 14004, 14900, 16324, 17358, 17358], label: 'West', fill: false, borderColor: 'blue' },
    { data: [179, 218, 276, 318, 370, 418, 506, 623, 780, 863, 941, 1097, 1198, 1482, 1776, 1965, 2332, 2797,
    2986, 3358, 3631, 3920, 4219, 4492, 4887, 5176, 5503, 5848, 6109, 6396, 6761, 7132, 7226, 7544, 7814, 8346, 8346], label: 'Central', fill: false },
  ];

  dailyRecoveredCases =  [
    { data: [22, 28, 30, 33, 35, 38, 47, 58, 64, 73, 76, 77, 88, 88, 88, 106, 124, 138, 181, 198, 223, 281, 
    507, 711, 912, 1067, 1167, 1236, 1277, 1314, 1350, 1592, 1641, 1670, 1795, 1918, 1918], label: 'North Zone', fill: false  },
    { data: [30, 31, 48, 51, 57, 64, 79, 102, 111, 128, 155, 174, 190, 259, 288, 410, 446, 514, 569, 740, 872, 968,
    1088, 1162, 1415, 1479, 1638, 1788, 2000, 2079, 2247, 2414, 2467, 2609, 2820, 2991, 2991], label: 'South', fill: false  },
    { data: [0, 0, 3, 3, 9, 10, 10, 12, 12, 15, 15, 19, 19, 19, 51, 68, 81, 85, 96, 114, 124, 137, 
    152, 162, 172, 188, 213, 214, 222, 241, 252, 272, 281, 314, 349, 383, 383], label: 'East', fill: false  },
    { data: [26, 35, 45, 45, 49, 52, 56, 60, 78, 81, 104, 142, 151, 219, 257, 269, 289, 323, 364, 380, 425, 465, 
    620, 710, 873, 975, 1105, 1229, 1365, 1508, 1683, 1829, 2127, 2393, 2621, 2903, 2903], label: 'West', fill: false, borderColor: 'blue'  },
    { data: [16, 19, 24, 26, 26, 26, 45, 45, 54, 56, 61, 66, 67, 67, 81, 127, 248, 284, 305, 335, 371, 451, 
    476, 515, 588, 616, 691, 743, 1050, 1220, 1495, 1690, 1809, 1903, 2366, 2692, 2692], label: 'Central', fill: false  },
  ];

  dailyDeathCases =  [
    { data: [14, 16, 17, 17, 18, 22, 26, 32, 33, 38, 43, 48, 67, 51, 59, 64, 68, 70, 72, 72, 73, 75, 79, 81, 82, 83, 85, 87, 90, 93, 97, 97], label: 'North Zone', fill: false  },
    { data: [16, 16, 19, 21, 21, 24, 26, 29, 31, 33, 43, 49, 53, 62, 63, 64, 65, 75, 80, 85, 89, 96, 101, 102, 105, 105, 106, 109, 109, 113, 119, 119], label: 'South', fill: false  },
    { data: [4, 4, 4, 4, 5, 7, 7, 8, 9, 9, 12, 12, 13, 13, 16, 17, 19, 19, 19, 23, 23, 23, 26, 26, 28, 28, 30, 30, 41, 42, 43, 43], label: 'East', fill: false  },
    { data: [25, 28, 35, 57, 61, 77, 88, 114, 129, 149, 175, 186, 208, 223, 232, 249, 269, 290, 309, 346, 372, 395, 428, 456, 493, 531, 581, 629, 673, 721, 783, 783], label: 'West', fill: false, borderColor: 'blue'  },
    { data: [10, 10, 10, 12, 19, 19, 23, 23, 40, 44, 51, 58, 67, 69, 82, 94, 98, 105, 121, 126, 129, 134, 145, 161, 178, 190, 206, 219, 234, 249, 264, 264], label: 'Central', fill: false  },
  ];
  ...
  2687, 2919, 3205, 3323, 3651, 4203, 4669, 5221, 5652, 6430, 6817, 7628, 8068, 8590, 9318, 9915, 10498, 11506, 12296, 12296];
  dailyMaharashtraRec = [1593, 1773, 1879, 2000, 2000]
  dailyMaharashtraDth = [432, 459, 485, 521, 521]
  ...
  dailyKeralaRec = [369, 383, 392, 400, 400]
  dailyKeralaDth = [4, 4, 4, 4, 4]
  dailyUP =  [75, 88, 101, 108, 121, 126, 174, 227, 305, 305, 343, 410, 431, 433, 452, 483, 657, 
  735, 773, 846, 969, 1084, 1176, 1294, 1412, 1509, 1604, 1778, 1843, 1955, 2033, 2115, 2134, 2203, 2328, 2626, 2626];
  dailyUPRec = [510, 513, 654, 698, 698]
  dailyUPDth = [39, 39, 42, 43, 43]
  dailyKarnataka =      [80, 88, 101, 110, 110, 124, 128, 144, 151, 175, 175, 181, 197, 214, 226, 247, 258, 
  277, 315, 353, 371, 384, 395, 415, 425, 443, 463, 489, 503, 511, 520, 535, 565, 589, 606, 606];
  dailyKarnatakaRec = [216, 229, 392, 282, 282]
  dailyKarnatakaDth = [21, 21, 22, 25, 25]
  dailyDelhi =          [53, 72, 120, 152, 219, 295, 445, 503, 523, 576, 576, 669, 898, 903, 1069, 1154, 1510, 
  1561, 1578, 1640, 1707, 1893, 2003, 2081, 2156, 2248, 2376, 2514, 2625, 2918, 3108, 3314, 3439, 3515, 3738, 4122, 4122];
  dailyDelhiRec = [1092, 1094, 1167, 1256, 1256]
  dailyDelhiDth = [56, 59, 61, 64, 64]
  dailyTelangana =      [69, 70, 77, 92, 97, 154, 159, 269, 321, 364, 427, 442, 473, 504, 504, 562, 624, 
  647, 698, 743, 791, 844, 873, 919, 945, 960, 984, 984, 991, 1002, 1004, 1012, 1012, 1038, 1039, 1063, 1063];  
  dailyTelenganaRec = [367, 397, 441, 458, 458]
  dailyTelenganaDth = [26, 26, 26, 28, 28]
  dailyGujarat =        [58, 69, 74, 87, 87, 88, 105, 122, 144, 165, 165, 179, 241, 308, 432, 539, 617, 
  695, 871, 1021, 1272, 1604, 1851, 2066, 2272, 2407, 2624, 2815, 3071, 3301, 3548, 3744, 4082, 4395, 4721, 5055, 5055];
  dailyGujaratRec = [527, 613, 735, 896, 896]
  dailyGujaratDth = [197, 214, 236, 262, 262]
  dailyTN =             [50, 67, 124, 234, 309, 309, 411, 485, 571, 621, 690, 738, 834, 911, 969, 1075, 1173, 
  1204, 1242, 1267, 1323, 1372, 1477, 1520, 1596, 1629, 1683, 1755, 1821, 1885, 1937, 2058, 2162, 2323, 2526, 2757, 2757];
  dailyTNRec = [1210, 1258, 1312, 1341, 1341]
  dailyTNDth = [27, 27, 28, 29, 29]
  dailyRajasthan =      [57, 69, 93, 108, 133, 154, 200, 200, 274, 288, 328, 383, 463, 553, 700, 812, 879, 
  1005, 1023, 1131, 1229, 1351, 1478, 1576, 1801, 1890, 1964, 2034, 2083, 2185, 2262, 2364, 2438, 2584, 2666, 2772, 2772];
  dailyRajasthanRec = [769, 836, 1116, 1121, 1121]
  dailyRajasthanDth = [51, 58, 62, 65, 65]
  ...
  278, 300, 314, 328, 341, 350, 368, 380, 407, 427, 454, 494, 523, 546, 565, 581, 614, 639, 666, 666];
  dailyJKRec = [192, 216, 247, 254, 254]
  dailyJKDth = [8, 8, 8, 8, 8]
  dailyPunjab =         [38, 39, 41, 44, 46, 46, 57, 57, 76, 91, 91, 101, 132, 132, 151, 167, 176, 
  186, 186, 186, 202, 219, 219, 245, 251, 277, 277, 298, 298, 313, 313, 322, 357, 357, 480, 772, 772];
  dailyPunjabRec = [90, 90, 90, 112, 112]
  dailyPunjabDth = [19, 19, 19, 20, 20]
  dailyHaryana =        [33, 35, 40, 40, 47, 47, 49, 59, 84, 90, 147, 169, 169, 177, 185, 185, 199, 
  199, 205, 205, 225, 233, 233, 254, 254, 262, 272, 272, 289, 289, 296, 310, 310, 313, 360, 394, 394];
  dailyHaryanaRec = [209, 209, 227, 227, 227]
  dailyHaryanaDth = [3, 3, 4, 4, 4]
  ...
  213, 231, 255, 287, 310, 339, 392, 423, 456, 514, 571, 611, 649, 697, 725, 758, 795, 795, 922, 922];
  dailyWBRec = [124, 139, 139, 151, 151]
  dailyWBDth = [22, 33, 33, 33, 33]
  dailyBihar =          [11, 15, 21, 24, 24, 29, 30, 30, 32, 32, 38, 39, 60, 60, 64, 64, 66, 
  70, 74, 83, 85, 86, 96, 114, 126, 148, 176, 228, 251, 277, 345, 383, 392, 418, 471, 482, 482];
  dailyBiharRec = [65, 82, 98, 117, 117]
  dailyBiharDth = [2, 2, 3, 4, 4]
  dailyOdisha =         [3, 3, 3, 4, 4, 5, 5, 20, 21, 42, 42, 42, 44, 48, 54, 54, 55, 
  60, 60, 60, 60, 61, 68, 74, 82, 83, 90, 94, 103, 108, 118, 125, 149, 149, 160, 160];
  ...
  dailyChattisgarh =    [36, 37, 37, 37, 38, 40, 43, 43, 43];
  dailyChattisgarhRec = [34, 36, 36, 36]
  dailyChattisgarhDth = [0, 0, 0, 0]
  dailyUttarakhand =    [48, 50, 51, 51, 55, 57, 58, 59, 59];
