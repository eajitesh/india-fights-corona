...
export class IndianStatesService {
  ...
  dailyConfirmedCases = [
    ...
    2342, 2419, 2539, 2766, 2888, 3031, 3125, 3279, 3437, 3652, 3796, 4133, 4365, 4629, 4805, 4917, 5367, 6128, 6969, 7558], label: 'North Zone', fill: false },
    { data: [422, 493, 598, 799, 958, 1047, 1169, 1409, 1598, 1768, 1948, 2070, 2240, 2392, 2472, 2710, 2925, 3036,
    3195, 3348, 3503, 3624, 3791, 4042, 4230, 4390, 4562, 4774, 4914, 5085, 5243, 5461, 5577, 5867, 6155, 6550, 6938, 7553], label: 'South', fill: false, borderColor: 'red'  },
    { data: [35, 42, 55, 71, 86, 108, 134, 163, 167, 200, 215, 230, 267, 286, 304, 327, 374, 417,
    440, 478, 518, 545, 598, 679, 730, 790, 890, 1007, 1087, 1171, 1321, 1389, 1439, 1525, 1588, 1743, 1834, 2162], label: 'East', fill: false },
    { data: [256, 289, 381, 427, 508, 521, 602, 619, 899, 1040, 1190, 1321, 1612, 1889, 2200, 2531, 2961, 3389,
    3797, 4233, 4602, 5262, 6061, 6742, 7500, 8066, 9061, 9639, 10706, 11376, 12145, 13069, 14004, 14900, 16324, 17358, 18409, 20352], label: 'West', fill: false, borderColor: 'blue' },
    { data: [179, 218, 276, 318, 370, 418, 506, 623, 780, 863, 941, 1097, 1198, 1482, 1776, 1965, 2332, 2797,
    2986, 3358, 3631, 3920, 4219, 4492, 4887, 5176, 5503, 5848, 6109, 6396, 6761, 7132, 7226, 7544, 7814, 8346, 8657, 9087], label: 'Central', fill: false },
  ];
  ...
  dailyRecoveredCases =  [
    ...
    507, 711, 912, 1067, 1167, 1236, 1277, 1314, 1350, 1592, 1641, 1670, 1795, 1918, 2081, 2192], label: 'North Zone', fill: false  },
    { data: [30, 31, 48, 51, 57, 64, 79, 102, 111, 128, 155, 174, 190, 259, 288, 410, 446, 514, 569, 740, 872, 968,
    1088, 1162, 1415, 1479, 1638, 1788, 2000, 2079, 2247, 2414, 2467, 2609, 2820, 2991, 3135, 3407], label: 'South', fill: false  },
    { data: [0, 0, 3, 3, 9, 10, 10, 12, 12, 15, 15, 19, 19, 19, 51, 68, 81, 85, 96, 114, 124, 137, 
    152, 162, 172, 188, 213, 214, 222, 241, 252, 272, 281, 314, 349, 383, 395, 472], label: 'East', fill: false  },
    { data: [26, 35, 45, 45, 49, 52, 56, 60, 78, 81, 104, 142, 151, 219, 257, 269, 289, 323, 364, 380, 425, 465, 
    620, 710, 873, 975, 1105, 1229, 1365, 1508, 1683, 1829, 2127, 2393, 2621, 2903, 3164, 3667], label: 'West', fill: false, borderColor: 'blue'  },
    { data: [16, 19, 24, 26, 26, 26, 45, 45, 54, 56, 61, 66, 67, 67, 81, 127, 248, 284, 305, 335, 371, 451, 
    476, 515, 588, 616, 691, 743, 1050, 1220, 1495, 1690, 1809, 1903, 2366, 2692, 2987, 3413], label: 'Central', fill: false  },
  ];

  dailyDeathCases =  [
    { data: [14, 16, 17, 17, 18, 22, 26, 32, 33, 38, 43, 48, 67, 51, 59, 64, 68, 70, 72, 72, 73, 75, 79, 81, 82, 83, 85, 87, 90, 93, 97, 99, 103], label: 'North Zone', fill: false  },
    { data: [16, 16, 19, 21, 21, 24, 26, 29, 31, 33, 43, 49, 53, 62, 63, 64, 65, 75, 80, 85, 89, 96, 101, 102, 105, 105, 106, 109, 109, 113, 119, 125, 128], label: 'South', fill: false  },
    { data: [4, 4, 4, 4, 5, 7, 7, 8, 9, 9, 12, 12, 13, 13, 16, 17, 19, 19, 19, 23, 23, 23, 26, 26, 28, 28, 30, 30, 41, 42, 43, 45, 143], label: 'East', fill: false  },
    { data: [25, 28, 35, 57, 61, 77, 88, 114, 129, 149, 175, 186, 208, 223, 232, 249, 269, 290, 309, 346, 372, 395, 428, 456, 493, 531, 581, 629, 673, 721, 783, 838, 902], label: 'West', fill: false, borderColor: 'blue'  },
    { data: [10, 10, 10, 12, 19, 19, 23, 23, 40, 44, 51, 58, 67, 69, 82, 94, 98, 105, 121, 126, 129, 134, 145, 161, 178, 190, 206, 219, 234, 249, 264, 281, 306], label: 'Central', fill: false  },
  ];
  ...
  '18/04', '19/04', '20/04', '21/04', '22/04', '23/04', '24/04', '25/04', '26/04', '27/04', '28/04', '29/04', '30/04', '01/05', '02/05', '03/05', '04/05', '05/05'];
  ...
  dailyPunjabRec = [90, 90, 90, 112, 117, 121]
  ...
  503, 534, 572, 603, 603, 722, 757, 813, 895, 955, 1061, 1097, 1177, 1259, 1332, 1332, 1403, 1463, 1583, 1650, 1650];
  dailyAPRec = [287, 321, 403, 488, 524, 524]
