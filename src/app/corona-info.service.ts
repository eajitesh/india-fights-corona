...
export class CoronaInfoService {
  ...
  dailyDischargedDeathCases = [
    { data: [150, 159, 177, 190, 237, 280, 319, 353, 411, 478, 515, 652, 765, 980, 1190, 1344, 1515, 1767, 2015, 2302, 2842, 3260, 3960, 4325, 5063, 5210, 5914, 6362, 7027, 7797, 8373, 9065, 9951], label: 'Discharged', fill: false, borderColor: 'green' },
    { data: [46, 55, 68, 71, 77, 89, 111, 124, 149, 169, 206, 242, 273, 324, 353, 392, 420, 452, 488, 519, 559, 603, 652, 686, 775, 779, 826, 886, 937, 1008, 1075, 1152, 1218], label: 'Death', fill: false, borderColor: 'red' },
  ];
